#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=0 python examples/parsing.py --config configs/parsing/biaffine.json --num_epochs 1000 --batch_size 32 \
 --opt adam --learning_rate 0.001 --lr_decay 0.999995 --beta1 0.9 --beta2 0.999 --eps 1e-8 --grad_clip 5.0 \
 --warmup_steps 10 --weight_decay 0.0 --unk_replace 0.5 \
