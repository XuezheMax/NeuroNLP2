#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=0 python ner.py --config configs/ner/conll03.json --num_epochs 200 --batch_size 16 \
 --loss_type sentence --optim sgd --learning_rate 0.01 --lr_decay 0.99999 --warmup_steps 100 --weight_decay 0.0 --unk_replace 0.0 \
