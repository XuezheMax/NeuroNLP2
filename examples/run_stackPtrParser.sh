...
CUDA_VISIBLE_DEVICES=2 python examples/StackPointerParser.py --mode FastLSTM --num_epochs 500 --batch_size 32 --hidden_size 1024 --num_layers 4 \
 ...
 --opt adam --learning_rate 0.001 --decay_rate 0.75 --schedule 10 --coverage 0.0 --gamma 0.0 --clip 5.0 \
 --p_in 0.33 --p_out 0.33 --p_rnn 0.33 0.33 --unk_replace 0.5 --beam 5 --prior_order deep_first \
