#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=1 python examples/MSTParser.py --mode LSTM --num_epochs 200 --batch_size 64 --hidden_size 128 --num_layers 2 --num_filters 50 --tag_space 128 \
 --learning_rate 0.01 --decay_rate 0.05 --schedule 10 30 50 70 100 --gamma 0.0 --dropout std --p 0.5 --biaffine \
