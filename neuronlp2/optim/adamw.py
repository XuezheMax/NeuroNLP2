...
class AdamW(Optimizer):
    ...
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.999), eps=1e-8, warmups=0, init_lr=1e-7, weight_decay=1e-2, amsgrad=False):
        if not 0.0 <= lr:
        ...
        defaults = dict(lr=lr, betas=betas, eps=eps, warmups=warmups, weight_decay=weight_decay,
                        init_lr=init_lr, base_lr=lr, amsgrad=amsgrad)
